...
public class ReverseTransactionsAdapter extends RecyclerView.Adapter<ReverseTransactionsAdapter.HistoryViewHolder> {
    private List<GetTransactionsResponse> getTransactionsResponse;
    private OnMyItemClickListener onMyItemClickListener;
    public ReverseTransactionsAdapter(List<GetTransactionsResponse> getTransactionsResponse) {
    ...
    public HistoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.reversed_history_item, parent, false);
        return new HistoryViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HistoryViewHolder holder, int position) {
       holder.tvDate.setText(getTransactionsResponse.get(position).getCreateDate());
