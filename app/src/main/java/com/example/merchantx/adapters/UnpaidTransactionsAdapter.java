...
public class UnpaidTransactionsAdapter extends RecyclerView.Adapter<UnpaidTransactionsAdapter.HistoryViewHolder> {
    private List<GetTransactionsResponse> getTransactionsResponse;
    private OnMyItemClickListener onMyItemClickListener;
    public UnpaidTransactionsAdapter(List<GetTransactionsResponse> getTransactionsResponse) {
    ...
    public HistoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.unpaid_history_item, parent, false);
